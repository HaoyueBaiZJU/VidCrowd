...
class TrainGlobalConfig:
    ...
    folder = 'DENet-drone_people-8.30-448'
    downsample = args.downsample
...
if args.mode == 'train':
    ...
    #checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/cps/smartcity/DENet-9.1-smartcity-448/best-checkpoint-011epoch.bin')
