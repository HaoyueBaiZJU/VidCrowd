...
class TrainGlobalConfig:
    ...
    folder = 'MCNN-8.31-smartcity-448-trial2'
    downsample = args.downsample
...
if args.mode == 'train':
    ...
    checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/MCNN-8.31-smartcity-448-trial2/best-checkpoint-019epoch.bin')
    ...
    for imgs, dmaps, fns, points in tqdm(val_loader):
        with torch.no_grad():
            ...
            preds = test_net(imgs)*16 / LOG_PARA
        dmaps = dmaps*16 / LOG_PARA
