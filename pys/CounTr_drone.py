...
class TrainGlobalConfig:
    ...
    folder = 'counTR_9.6_drone_vehicle'
    downsample = args.downsample
...
if args.mode == 'train':
    ...
    test_net = net
    checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/counTR_drone_people/best-checkpoint-105epoch.bin')
