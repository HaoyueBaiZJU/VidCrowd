...
train_dataset = Video_Counting_Dataset(path=path, image_fnames=glob(sm_train_images+'/*.jpg'),
                                       ...
                                       sample=1, crop_size=args.crop_size
)
...
class TrainGlobalConfig:
    ...
    folder = 'csr_conv_lstm_07_22_resized'
...
class ConvLSTM(nn.Module):
    def __init__(self):
        ...
        self.encoder_1_convlstm = ConvLSTMCell(input_dim=1, # original 3
                                            hidden_dim=128, #64
                                            kernel_size=(3, 3),
                                            bias=True)
...
model_path = f'/mnt/home/hheat/USERDIR/counting-bench/model/CSRNet_7_16/last-checkpoint.bin'
net = CSRNet_LSTM(model_path).cuda()
