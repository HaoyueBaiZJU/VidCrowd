...
class TrainGlobalConfig:
    ...
    folder = 'DSSINet-drone_people-8.30-448'
    downsample = args.downsample
...
if args.mode == 'train':
    ...
    #checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/cps/vidcrowd/DSSINet-11.23-784/best-checkpoint-100epoch.bin')
