...
train_dataset = Crop_Dataset(path=path,
                             image_fnames=fp[:split],dmap_folder='/dmap_amr',
...
if args.mode == 'train':
    ...
    checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/cps/vidcrowd/AMRNet-7.26-784/best-checkpoint-120epoch.bin')
