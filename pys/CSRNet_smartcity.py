...
class TrainGlobalConfig:
    ...
    folder = 'CSRNet-9.1-smartcity-448'
    downsample = args.downsample
...
if args.mode == 'train':
    ...
    test_net = CSRNet().cuda()
    test_net = nn.DataParallel(test_net)

    checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/CSRNet-9.1-smartcity-448/best-checkpoint-009epoch.bin')
