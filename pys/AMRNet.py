...
train_dataset = Crop_Dataset(path=path,
                             image_fnames=train_fp,dmap_folder='/dmap_amr',
...
def run_training():
    ...
    #fitter.load('/mnt/home/zpengac/USERDIR/count/drone_benchmark/AMRNet-7.23-784/last-checkpoint.bin')
...
if args.mode == 'train':
    ...
    checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/cps/drone_people/AMRNet-drone_people-9.28-448/best-checkpoint-021epoch.bin')
