...
if args.mode == 'train':
    ...
    checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/DSSINet-11.23-784/best-checkpoint-100epoch.bin')
