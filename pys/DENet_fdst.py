...
class TrainGlobalConfig:
    ...
    folder = 'DENet-9.1-fdst-512-trial2'
    downsample = args.downsample
...
if args.mode == 'train':
    ...
    checkpoint = torch.load(f'/mnt/home/zpengac/USERDIR/count/drone_benchmark/DENet-9.1-fdst-512-trial2/best-checkpoint-097epoch.bin')
